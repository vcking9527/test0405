...
export class Client {
     ...
     * @return Success
     */
    lineChart(  cancelToken?: CancelToken | undefined): Promise<AccountLineChartDtoIEnumerableApiResponse> {
        let url_ = this.baseUrl + "/api/account/line-chart";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processLineChart(_response);
        });
    }

    protected processLineChart(response: AxiosResponse): Promise<AccountLineChartDtoIEnumerableApiResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = AccountLineChartDtoIEnumerableApiResponse.fromJS(resultData200);
            return Promise.resolve<AccountLineChartDtoIEnumerableApiResponse>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<AccountLineChartDtoIEnumerableApiResponse>(null as any);
    }
}
...
export class AccountLineChartDto implements IAccountLineChartDto {
    ageRange?: string | undefined;
    averageBalance?: number;

    constructor(data?: IAccountLineChartDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.averageBalance = _data["averageBalance"];
        }
    }

    static fromJS(data: any): AccountLineChartDto {
        data = typeof data === 'object' ? data : {};
        let result = new AccountLineChartDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["averageBalance"] = this.averageBalance;
        return data;
    }
}

export interface IAccountLineChartDto {
    ageRange?: string | undefined;
    averageBalance?: number;
}

export class AccountLineChartDtoIEnumerableApiResponse implements IAccountLineChartDtoIEnumerableApiResponse {
    message?: string | undefined;
    data?: AccountLineChartDto[] | undefined;

    constructor(data?: IAccountLineChartDtoIEnumerableApiResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["data"])) {
                ...
                for (let item of _data["data"])
                    this.data!.push(AccountLineChartDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): AccountLineChartDtoIEnumerableApiResponse {
        data = typeof data === 'object' ? data : {};
        let result = new AccountLineChartDtoIEnumerableApiResponse();
        result.init(data);
        return result;
    }
...
export interface IAccountLineChartDtoIEnumerableApiResponse {
    message?: string | undefined;
    data?: AccountLineChartDto[] | undefined;
}
